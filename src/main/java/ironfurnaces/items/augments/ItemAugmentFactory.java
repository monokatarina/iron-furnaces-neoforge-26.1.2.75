...
public class ItemAugmentFactory extends ItemAugmentBlue {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext pContext, TooltipDisplay tooltipDisplay, Consumer<Component> tooltipAdder, TooltipFlag pTooltipFlag) {
        ...
        tooltipAdder.accept(Component.translatable("tooltip." + IronFurnaces.MOD_ID + ".augment_factory_pro").setStyle(Style.EMPTY.applyFormat((ChatFormatting.GREEN))));
        tooltipAdder.accept(Component.translatable("tooltip." + IronFurnaces.MOD_ID + ".augment_factory_con").setStyle(Style.EMPTY.applyFormat(ChatFormatting.DARK_RED)));
